...
const DRAGGABLE_BLOCK_MENU_CLASSNAME = 'ib-block-control-menu';
...
export default function BlockControlPlugin({
	...
	const [blockPickerPosition, setBlockPickerPosition] = useState<{
		top: number;
		left: number;
	} | null>(null);
			...
			<DraggableBlockPlugin_EXPERIMENTAL
				...
				menuComponent={
					...
					>
						<button
							type="button"
							className="ib-block-control-button ib-block-control-plus"
							onClick={handlePlusClick}
							aria-label="Add block"
						>
							<Plus size={18} />
						</button>
						<div className="ib-block-control-icon">
				...
				targetLineComponent={
					<div
						ref={targetLineRef}
						className="ib-block-control-target-line"
					/>
				}
				isOnMenu={isOnMenu}
			/>
